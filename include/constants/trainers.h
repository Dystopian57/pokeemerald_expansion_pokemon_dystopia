...
#define TRAINER_PIC_ORPHAN_MALE           93

#define TRAINER_PIC_CAMELIABATTLE               94
#define TRAINER_PIC_CLERKFBATTLE                95
#define TRAINER_PIC_COSPLAYERFBATTLE            96
#define TRAINER_PIC_COSPLAYERMBATTLE            97
#define TRAINER_PIC_DEVONADMINFBATTLE           98
#define TRAINER_PIC_DEVONADMINMBATTLE           99
#define TRAINER_PIC_DEVONGRUNTFBATTLE           100
#define TRAINER_PIC_DEVONGRUNTMBATTLE           101
#define TRAINER_PIC_HERMITMBATTLE               102
#define TRAINER_PIC_MEDICMBATTLE                103
#define TRAINER_PIC_MERCENARYMBATTLE            104
#define TRAINER_PIC_MUSASHIBATTLE               105
#define TRAINER_PIC_NETRUNNERFBATTLE            106
#define TRAINER_PIC_NETRUNNERMBATTLE            107
#define TRAINER_PIC_OLDNORMANBATTLE             108
#define TRAINER_PIC_ORPHANGIRLFBATTLE           109
#define TRAINER_PIC_PATIENTMBATTLE              110
#define TRAINER_PIC_PUNKFBATTLE                 111
#define TRAINER_PIC_PUNKMBATTLE                 112
#define TRAINER_PIC_REBELADMINFBATTLE           113
#define TRAINER_PIC_REBELADMINMBATTLE           114
#define TRAINER_PIC_REBELGRUNTFBATTLE           115
#define TRAINER_PIC_REBELGRUNTMBATTLE           116
#define TRAINER_PIC_REPORTERSBATTLE             117
#define TRAINER_PIC_ROXANNEDEVONBATTLE          118
#define TRAINER_PIC_SCAVENGERFBATTLE            119
#define TRAINER_PIC_SCAVENGERMBATTLE            120
#define TRAINER_PIC_SCIENTISTFBATTLE            121
#define TRAINER_PIC_SCIENTISTMBATTLE            122
#define TRAINER_PIC_SHARPYBATTLE                123
#define TRAINER_PIC_SIDNEYREBELBATTLE           124
#define TRAINER_PIC_TECHNICIANFBATTLE           125
#define TRAINER_PIC_TECHNICIANMBATTLE           126
#define TRAINER_PIC_THEORISTMBATTLE             127
#define TRAINER_PIC_TOMOKOBATTLE                128
#define TRAINER_PIC_TOURISTFBATTLE              129
#define TRAINER_PIC_TOURISTMBATTLE              130
#define TRAINER_PIC_VETERANMBATTLE              131
#define TRAINER_PIC_SHADYDEALERMBATTLE          132
#define TRAINER_PIC_GANGBIKERFBATTLE            133
#define TRAINER_PIC_GANGBIKERMBATTLE            134
#define TRAINER_PIC_HAZARDDIVERMBATTLE          135
#define TRAINER_PIC_MERCENARYFBATTLE            136
#define TRAINER_PIC_PATIENTFBATTLE              137
#define TRAINER_PIC_CONSCRIPTEDMBATTLE          138
...
#define TRAINER_PIC_SURGEBATTLE                 148
...
enum TrainerClassID
{
    ...
    TRAINER_CLASS_ORPHAN,

    TRAINER_CLASS_CAMELIA,
    TRAINER_CLASS_CLERKF,
    TRAINER_CLASS_COSPLAYERF,
    TRAINER_CLASS_COSPLAYERM,
    TRAINER_CLASS_DEVONADMINF,
    TRAINER_CLASS_DEVONADMINM,
    TRAINER_CLASS_DEVONGRUNTF,
    TRAINER_CLASS_DEVONGRUNTM,
    TRAINER_CLASS_HERMITM,
    TRAINER_CLASS_MEDICM,
    TRAINER_CLASS_MERCENARYM,
    TRAINER_CLASS_MUSASHI,
    TRAINER_CLASS_NETRUNNERF,
    TRAINER_CLASS_NETRUNNERM,
    TRAINER_CLASS_OLDNORMAN,
    TRAINER_CLASS_ORPHANGIRLF,
    TRAINER_CLASS_PATIENTM,
    TRAINER_CLASS_PUNKF,
    TRAINER_CLASS_PUNKM,
    TRAINER_CLASS_REBELADMINF,
    TRAINER_CLASS_REBELADMINM,
    TRAINER_CLASS_REBELGRUNTM,
    TRAINER_CLASS_REBELGRUNTF,
    TRAINER_CLASS_REPORTERS,
    TRAINER_CLASS_ROXANNEDEVON,
    TRAINER_CLASS_SCAVENGERF,
    TRAINER_CLASS_SCAVENGERM,
    TRAINER_CLASS_SCIENTISTF,
    TRAINER_CLASS_SCIENTISTM,
    TRAINER_CLASS_SHARPY,
    TRAINER_CLASS_SIDNEYREBEL,
    TRAINER_CLASS_TECHNICIANF,
    TRAINER_CLASS_TECHNICIANM,
    TRAINER_CLASS_THEORISTM,
    TRAINER_CLASS_TOMOKO,
    TRAINER_CLASS_TOURISTF,
    TRAINER_CLASS_TOURISTM,
    TRAINER_CLASS_VETERANM,

    TRAINER_CLASS_SHADYDEALERM,
    TRAINER_CLASS_CONSCRIPTF,
    TRAINER_CLASS_CONSCRIPTM,
    TRAINER_CLASS_FOREIGNSPYM,
    TRAINER_CLASS_GANGBIKERF,
    TRAINER_CLASS_GANGBIKERM,
