...
#define balsamofficeemptytv                  0x5E
#define FLAG_NO_ESCAPE                       0x5F
...
#define declinedcraterreporterhelp           0x6C // Set after defeating Flannery, so the player cant white out from poison before receiving Go Goggles
...
#define loanedgrassbook         0x82
#define loanedelectricbook           0x83
#define loanedprotectTM          0x84
#define loanedsafeguardTM            0x85
...
#define SamanthaBalsamInteraction         0xE6
#define SamanthaJoelInteraction                0xE7
#define SamanthaBirchInteraction          0xE8
...
#define FLAG_REGISTERED_VETERAN103           (TRAINER_REGISTERED_FLAGS_START + REMATCH_VETERAN103)
#define FLAG_REGISTERED_TOURISTGREATCRATER   (TRAINER_REGISTERED_FLAGS_START + REMATCH_TOURISTGREATCRATER)
#define FLAG_REGISTERED_CONSPIRACYGREATCRATER    (TRAINER_REGISTERED_FLAGS_START + REMATCH_CONSPIRACYGREATCRATER)
//#define FLAG_REGISTERED_HEXGIRLMAUSOLEUM    (TRAINER_REGISTERED_FLAGS_START + REMATCH_HEXGIRLMAUSOLEUM)
//#define FLAG_REGISTERED_ORPHAN_MALE_101   (TRAINER_REGISTERED_FLAGS_START + REMATCH_TRAINER_ORPHAN_MALE_101)
#define FLAG_REGISTERED_TRAINER_FISHER_103   (TRAINER_REGISTERED_FLAGS_START + REMATCH_TRAINER_FISHER_103)
#define FLAG_REGISTERED_TRAINER_SHADYDEALER_103    (TRAINER_REGISTERED_FLAGS_START + REMATCH_TRAINER_SHADYDEALER_103)
#define FLAG_REGISTERED_HAZARDIVER_WATERFALL   (TRAINER_REGISTERED_FLAGS_START + REMATCH_HAZARDIVER_WATERFALL)
#define FLAG_REGISTERED_MERCENARYF_WATERFALL    (TRAINER_REGISTERED_FLAGS_START + REMATCH_MERCENARYF_WATERFALL)
...
#define ORASDowsing                           (SYSTEM_FLAGS + 0x85) // Unused Flag
...
#define donutquestcomplete                           (DAILY_FLAGS_START + 0x0)  // Unused Flag
