...
enum NationalDexOrder
{
    ...
    NATIONAL_DEX_PIKACHU_SAFE,
    NATIONAL_DEX_BULBASYNTH,
    NATIONAL_DEX_SMOTHQUIL,
    NATIONAL_DEX_POOCHAIN,
    NATIONAL_DEX_CHEERORB,
    NATIONAL_DEX_FOOMING,
    NATIONAL_DEX_MANCHINE,
    NATIONAL_DEX_WARABBIT,
    NATIONAL_DEX_NINKABURI,
    NATIONAL_DEX_SHIITAKO,
    NATIONAL_DEX_LOADTAD,
    NATIONAL_DEX_HELIPIP,
    NATIONAL_DEX_MUDDER,
    NATIONAL_DEX_GEOSLUG,
    NATIONAL_DEX_TUMBELA,
    NATIONAL_DEX_DOUNO,
    NATIONAL_DEX_PANSELIA,
    NATIONAL_DEX_VERIWOODO,
    NATIONAL_DEX_NIDORAN_I,
    NATIONAL_DEX_GUMMIN,
    NATIONAL_DEX_TRASHEAL,
    NATIONAL_DEX_GRIMANE,
    NATIONAL_DEX_KANGASKID,
    NATIONAL_DEX_TAMARAKKU,
    NATIONAL_DEX_GACHAPOD,
    NATIONAL_DEX_KAMOKEN,
    NATIONAL_DEX_WARTZ,
    NATIONAL_DEX_DELIBIN,
    NATIONAL_DEX_ROTOM_MONITOR,
    NATIONAL_DEX_ROLLOON,
    NATIONAL_DEX_MIMIYURUI,
    NATIONAL_DEX_ARYSTAL,
    NATIONAL_DEX_VERDOOM,
    NATIONAL_DEX_HOMBROX,
    NATIONAL_DEX_GYVEYENA,
...
#define JOHTO_DEX_COUNT     NATIONAL_DEX_CELEBI
    ...
    #define NATIONAL_DEX_COUNT  NATIONAL_DEX_GYVEYENA
...
{
    HOENN_DEX_NONE,
    HOENN_DEX_BULBASYNTH,
    HOENN_DEX_SMOTHQUIL,
    HOENN_DEX_WARABBIT,
    HOENN_DEX_PIKACHU_SAFE,
    HOENN_DEX_MIMIYURUI,
    HOENN_DEX_NINKABURI,
    HOENN_DEX_SHIITAKO,
    HOENN_DEX_ZIGZAGOON,
...
#define HOENN_DEX_COUNT (HOENN_DEX_RELICANTH + 1)
