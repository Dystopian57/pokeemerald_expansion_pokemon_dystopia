...
// Vs. Seeker
#define I_VS_SEEKER_CHARGING        VSSEEKER     // If this flag is assigned, the Vs Seeker functionality will be enabled. When the player has the Vs. Seeker, Match Call rematch functions will stop working. Documentation for the Vs. Seeker can be found in docs/tutorials/vs_seeker.md.

// ORAS Dowsing Machine
#define I_ORAS_DOWSING_FLAG         ORASDowsing           // Replace 0 with an unused flag to enable the Dowsing Machine mechanic from ORAS.
...
#define I_ORAS_DOWSING_COLOR_NONE   RGB_BLUE
