...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_PLAYERGOTMONEY]                       = COMPOUND_STRING("Obtained ¥{B_BUFF1} for winning!\p"),
    [STRINGID_PLAYERWHITEOUT]                       = COMPOUND_STRING("{PLAYER} no more Pokémon that can fight!\p"),
    [STRINGID_PLAYERWHITEOUT2_WILD]                 = COMPOUND_STRING("{PLAYER} panicked and dropped ¥{B_BUFF1}…"),
    [STRINGID_PLAYERWHITEOUT2_TRAINER]              = COMPOUND_STRING("{PLAYER} gave ¥{B_BUFF1} to the winner…"),
    [STRINGID_PLAYERWHITEOUT3]                      = COMPOUND_STRING("{PLAYER} leaves..."),
    ...
    [STRINGID_NORUNNINGFROMTRAINERS]                = COMPOUND_STRING("As a soldier, you were indoctrinated\nto never retreat from a fight!\p"),
