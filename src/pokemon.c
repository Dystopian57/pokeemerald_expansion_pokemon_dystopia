...
{
    HOENN_TO_NATIONAL(BULBASYNTH),
    HOENN_TO_NATIONAL(SMOTHQUIL),
    HOENN_TO_NATIONAL(WARABBIT),
    HOENN_TO_NATIONAL(PIKACHU_SAFE),
    HOENN_TO_NATIONAL(MIMIYURUI),
    HOENN_TO_NATIONAL(NINKABURI),
    HOENN_TO_NATIONAL(SHIITAKO),
    HOENN_TO_NATIONAL(ZIGZAGOON),
    HOENN_TO_NATIONAL(LINOONE),
    HOENN_TO_NATIONAL(POOCHAIN),
    ...
    HOENN_TO_NATIONAL(GEOSLUG),
    HOENN_TO_NATIONAL(FOOMING),
    ...
    HOENN_TO_NATIONAL(ROTOM_MONITOR),
    ...
    HOENN_TO_NATIONAL(MANCHINE),
    HOENN_TO_NATIONAL(VERDOOM),
    HOENN_TO_NATIONAL(LOADTAD),
    HOENN_TO_NATIONAL(HELIPIP),
    HOENN_TO_NATIONAL(ARYSTAL),
    ...
    HOENN_TO_NATIONAL(VERIWOODO),
    HOENN_TO_NATIONAL(WARTZ),
    HOENN_TO_NATIONAL(GUMMIN),
    HOENN_TO_NATIONAL(SCRAGGY),
    HOENN_TO_NATIONAL(SCRAFTY),
    HOENN_TO_NATIONAL(NOIBAT),
    HOENN_TO_NATIONAL(NOIVERN),
    HOENN_TO_NATIONAL(KAMOKEN),
    HOENN_TO_NATIONAL(GACHAPOD),
    ...
    HOENN_TO_NATIONAL(NIDORAN_I),
    HOENN_TO_NATIONAL(DOUNO),
    ...
    //HOENN_TO_NATIONAL(HOMBROX),
    //HOENN_TO_NATIONAL(GYVEYENA),
    //HOENN_TO_NATIONAL(PANSELIA),
    //HOENN_TO_NATIONAL(GRIMANE),
...
u16 GetBattleBGM(void)
{
    ...
    else if (gBattleTypeFlags & BATTLE_TYPE_TRAINER)
    {
        ...
        case TRAINER_CLASS_REBELGRUNTM:
        case TRAINER_CLASS_REBELGRUNTF:
            return MUS_MONSTERHOUSE;

        case TRAINER_CLASS_REBELADMINM:
        case TRAINER_CLASS_REBELADMINF:
            return MUS_BATTLEROYAL;

        case TRAINER_CLASS_DEVONGRUNTM:
        case TRAINER_CLASS_DEVONGRUNTF:
            return MUS_UNKNOWN4;

        case TRAINER_CLASS_DEVONADMINM:
        case TRAINER_CLASS_DEVONADMINF:
            return MUS_BOSSBATTLE;

        case TRAINER_CLASS_ROXANNEDEVON:
            return MUS_ALTRUTOWER;

        case TRAINER_CLASS_OLDNORMAN:
            return MUS_VS_GYM_LEADER;

        case TRAINER_CLASS_DEVONDRONE:
            return MUS_BATTLEAGAINSTAMACHINE;
