...
static const u8 gText_PokenavMatchCall_Strategy[] = _("About me");
static const u8 gText_PokenavMatchCall_TrainerPokemon[] = _("Favourite Pokémon");
static const u8 gText_PokenavMatchCall_SelfIntroduction[] = _("Pinned Post");
