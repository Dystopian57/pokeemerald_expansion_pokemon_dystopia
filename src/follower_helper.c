...
static const u8 sCondMsg27[] = _("Your POKéMON is mesmerized by\nthe unusually green landscape!");
static const u8 sCondMsg28[] = _("{STR_VAR_1} seems uneasy at being\nso deep underground.");
static const u8 sCondMsg29[] = _("{STR_VAR_1} seems scared of this place.");
