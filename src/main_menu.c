...
static const u8 *const sMalePresetNames[] = {
    ...
    //maybe dystopian characters instead
};

static const u8 *const sFemalePresetNames[] = {
    COMPOUND_STRING("RACHAEL"),
    COMPOUND_STRING("VALENTINE"),
    COMPOUND_STRING("ELLEN"),
    COMPOUND_STRING("MOTOKO"),
    COMPOUND_STRING("HAREY"),
    COMPOUND_STRING("KAT"),
    COMPOUND_STRING("LILIAN"),
    COMPOUND_STRING("CHANI"),
    COMPOUND_STRING("NICOLE"),
