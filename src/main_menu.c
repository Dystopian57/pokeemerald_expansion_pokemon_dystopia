...
static const struct MenuAction sMenuActions_Gender[] = {
    {COMPOUND_STRING("PIC 1"), {NULL}},
    {COMPOUND_STRING("PIC 2"), {NULL}}
};

static const u8 *const sMalePresetNames[] = {
    COMPOUND_STRING("WINSTON"), //1984
    COMPOUND_STRING("RICK"), //DO ANDROIDS DREAM
    COMPOUND_STRING("BERNARD"), //BRAND NEW WORLD
    COMPOUND_STRING("LEO"), //KALLOCAIN
    COMPOUND_STRING("KUNO"), //THE MACHINE STOPS

    COMPOUND_STRING("GUY"), //FAHRENHEIT 541
    COMPOUND_STRING("ANDREW"), //ENDER'S GAME
    COMPOUND_STRING("MITCH"), //HUNGER GAMES

    COMPOUND_STRING("BATTOU"), //GHOST IN THE SHELL
    COMPOUND_STRING("SHINYA"), //PSYCHO PASS

    COMPOUND_STRING("MICHAEL"), //RENDEZVOUS WITH RAMA

    COMPOUND_STRING("JOHN"), //THE MINORITY REPORT
    COMPOUND_STRING("PAUL"),
    COMPOUND_STRING("SCOTT"),
    COMPOUND_STRING("KEN"),
    ...
    COMPOUND_STRING("RAMEN")

};

static const u8 *const sFemalePresetNames[] = {
    COMPOUND_STRING("JULIA"), //1984
    COMPOUND_STRING("RACHAEL"), //DO ANDROIDS DREAM
    COMPOUND_STRING("LENINA"), //BRAND NEW WORLD 
    COMPOUND_STRING("LINDA"), //KALLOKAIN
    COMPOUND_STRING("VASHTI"), //THE MACHINE STOPS

    COMPOUND_STRING("OFFRED"), //HANDMAID'S TALE
    COMPOUND_STRING("VALENTINE"), //ENDER'S GAME
    COMPOUND_STRING("LUCY"), //HUNGER GAMES

    COMPOUND_STRING("MOTOKO"), //GHOST IN THE SHELL
    COMPOUND_STRING("AKANE"), //PSYCHO PASS

    COMPOUND_STRING("NICOLE"), //RENDEZVOUS WITH RAMA

    COMPOUND_STRING("LISA"), //MINORITY REPORT
    COMPOUND_STRING("VASQUEZ"),
...
static void Task_NewGameBirchSpeechSub_InitPokeBall(u8 taskId)
{
    ...
    CreatePokeballSpriteToReleaseMon(spriteId, gSprites[spriteId].oam.paletteNum, 112, 58, 0, 0, 32, PALETTES_BG, SPECIES_PIKACHU_SAFE);
...
{
    return CreateMonPicSprite_Affine(SPECIES_PIKACHU_SAFE, FALSE, 0, MON_PIC_AFFINE_FRONT, x, y, 14, TAG_NONE);
}
