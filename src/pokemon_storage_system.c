...
static const u8 *const sMenuTexts[] =
{
    ...
    [MENU_FOREST]     = COMPOUND_STRING("DECAY"),
    [MENU_CITY]       = COMPOUND_STRING("RUSTBORO"),
    [MENU_DESERT]     = COMPOUND_STRING("CONSTRUCTION"),
    [MENU_SAVANNA]    = COMPOUND_STRING("PETAL PARK"),
    [MENU_CRAG]       = COMPOUND_STRING("GREAT CRATER"),
    [MENU_VOLCANO]    = COMPOUND_STRING("SCRAPYARD"),
    [MENU_SNOW]       = COMPOUND_STRING("DEWFORD"),
    [MENU_CAVE]       = COMPOUND_STRING("CAVE"),
    [MENU_BEACH]      = COMPOUND_STRING("TOXIC BEACH"),
    [MENU_SEAFLOOR]   = COMPOUND_STRING("POISON SEA"),
    [MENU_RIVER]      = COMPOUND_STRING("MUDDY RIVER"),
    [MENU_SKY]        = COMPOUND_STRING("CLOUDY SKY"),
    [MENU_POLKADOT]   = COMPOUND_STRING("CAMMOUFLAGE"),
    [MENU_POKECENTER] = COMPOUND_STRING("DEVON"),
