...
const u8 gText_ExpandedPlaceholder_Brendan[] = _("BRUCE");
const u8 gText_ExpandedPlaceholder_May[] = _("ALMA");
...
const u8 gText_ThisIsAPokemon[] = _("This sorry thing here is a “SAFEMON.”{PAUSE 96}\p");
...
const u8 gText_DadsAdvice[] = _("There's no need to use this right now.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_Var1CertainlyHowMany[] = _("{STR_VAR_1}? Sure.\nHow many would you like?");
const u8 gText_Var1CertainlyHowMany2[] = _("{STR_VAR_1}? Sure.\nHow many would you like?");
...
const u8 gText_AnythingElseICanHelp[] = _("Anything else?");
const u8 gText_CanIHelpWithAnythingElse[] = _("Anything else?");
...
const u8 gText_AndMakeATrendySaying[] = _("and make a vicious warcry.");
const u8 gText_TheTrendySaying[] = _("Is this the warcry");
const u8 gText_IsAsShownOkay[] = _("you want to choose?");
...
const u8 gText_WhatsHipAndHappening[] = _("Create a warcry.");
...
const u8 gText_TrainerCardMoney[] = _("FUNDS");
const u8 gText_PokeDollar[] = _("¥"); // Unused
const u8 gText_TrainerCardPokedex[] = _("DEVON DEX");
...
const u8 gText_PlayerScurriedToCenter[] = _("{PLAYER} retreats to a POKéMON CENTER,\nwhile remembering painful memories about\nsimilar losses during the war …\p");
const u8 gText_PlayerScurriedBackHome[] = _("{PLAYER} retreats back home, and secretly\nregrets leaving the safety of its\nwalls…\p");
...
const u8 gText_MenuPokedex[] = _("DEVONDEX");
const u8 gText_MenuPokemon[] = _("POKéMON");
const u8 gText_MenuBag[] = _("BAG");
const u8 gText_MenuPokenav[] = _("DEVONAV");
...
const u8 gText_SavingBadges[] = _("TOKENS");
...
const u8 gText_IsThisTheCorrectTime[] = _("This should be the correct time...");
