...
static const u32 sMugshotImg_Thiefball[] = INCBIN_U32("graphics/mugshots/thief_ball.4bpp.lz");
static const u16 sMugshotPal_Thiefball[] = INCBIN_U16("graphics/mugshots/thief_ball.gbapal");


static const struct Mugshot sMugshots[] = {
    //ADD YOUR MUGSHOTS HERE
[MUGSHOT_THIEFBALL] = {.x = 16, .y = 5, .width = 16, .height = 16, .image = sMugshotImg_Thiefball, .palette = sMugshotPal_Thiefball},
};
