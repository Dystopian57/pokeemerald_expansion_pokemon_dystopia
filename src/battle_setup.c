...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_VETERAN103] = REMATCH(TRAINER_VETERAN_103, TRAINER_VETERAN_103_2, TRAINER_VETERAN_103_2, TRAINER_VETERAN_103_2, TRAINER_VETERAN_103_2, MAP_ROUTE103),
    [REMATCH_TOURISTGREATCRATER] = REMATCH(TRAINER_TOURIST_GREATCRATER, TRAINER_TOURIST_GREATCRATER_2, TRAINER_TOURIST_GREATCRATER_2, TRAINER_TOURIST_GREATCRATER_2, TRAINER_TOURIST_GREATCRATER_2, MAP_GREAT_CRATER),
    //[REMATCH_HAZARDIVER_WATERFALL] = REMATCH(TRAINER_HAZARDIVER_WATERFALL, TRAINER_HAZARDIVER_WATERFALL_2, TRAINER_HAZARDIVER_WATERFALL_2, TRAINER_HAZARDIVER_WATERFALL_2, TRAINER_HAZARDIVER_WATERFALL_2, MAP_WATERFALL_CAVE),
    //[REMATCH_MERCENARYF_WATERFALL] = REMATCH(TRAINER_MERCENARYF_WATERFALL, TRAINER_MERCENARYF_WATERFALL_2, TRAINER_MERCENARYF_WATERFALL_2, TRAINER_MERCENARYF_WATERFALL_2, TRAINER_MERCENARYF_WATERFALL_2, MAP_WATERFALL_CAVE),
    [REMATCH_CONSPIRACYGREATCRATER] = REMATCH(TRAINER_CONSPIRACY_GREATCRATER, TRAINER_CONSPIRACY_GREATCRATER_2, TRAINER_CONSPIRACY_GREATCRATER_2, TRAINER_CONSPIRACY_GREATCRATER_2, TRAINER_CONSPIRACY_GREATCRATER_2, MAP_GREAT_CRATER),
    [REMATCH_HEXGIRLMAUSOLEUM] = REMATCH(TRAINER_HEXGIRL_MAUSOLEUM, TRAINER_HEXGIRL_MAUSOLEUM, TRAINER_HEXGIRL_MAUSOLEUM, TRAINER_HEXGIRL_MAUSOLEUM, TRAINER_HEXGIRL_MAUSOLEUM, MAP_LITTLEROOT_MAUSOLEUM),
    ...
    [REMATCH_TRAINER_ORPHAN_MALE_101] = REMATCH(TRAINER_ORPHAN_MALE_101, TRAINER_ORPHAN_MALE_101, TRAINER_ORPHAN_MALE_101, TRAINER_ORPHAN_MALE_101, TRAINER_ORPHAN_MALE_101, MAP_ROUTE101),
    [REMATCH_TRAINER_FISHER_103] = REMATCH(TRAINER_FISHER_103, TRAINER_FISHER_103, TRAINER_FISHER_103, TRAINER_FISHER_103, TRAINER_FISHER_103, MAP_ROUTE103),
    [REMATCH_TRAINER_SHADYDEALER_103] = REMATCH(TRAINER_SHADYDEALER_103, TRAINER_SHADYDEALER_103, TRAINER_SHADYDEALER_103, TRAINER_SHADYDEALER_103, TRAINER_SHADYDEALER_103, MAP_PETALBURG_SEWERS),
...
enum BattleEnvironments BattleSetup_GetEnvironmentId(void)
{
    ...
    case MAP_TYPE_ROUTE:
        ...
        if (MetatileBehavior_IsTallGrass(tileBehavior))
            return BATTLE_ENVIRONMENT_GRASS;
        if (MetatileBehavior_IsSurfableWaterOrUnderwater(tileBehavior))
            return BATTLE_ENVIRONMENT_BROWNWATER;
    ...
    if (MetatileBehavior_IsSandOrDeepSand(tileBehavior) && gSaveBlock1Ptr->location.mapGroup == MAP_GROUP(MAP_ROUTE102) && gSaveBlock1Ptr->location.mapNum == MAP_NUM(MAP_ROUTE102))
        return BATTLE_ENVIRONMENT_SAND;

    if (MetatileBehavior_IsSandOrDeepSand(tileBehavior) && gSaveBlock1Ptr->location.mapGroup == MAP_GROUP(MAP_GREAT_CRATER) && gSaveBlock1Ptr->location.mapNum == MAP_NUM(MAP_GREAT_CRATER))
        return BATTLE_ENVIRONMENT_WHITESAND;
    
    if ((MetatileBehavior_IsTallGrass(tileBehavior)) && gSaveBlock1Ptr->location.mapGroup == MAP_GROUP(MAP_ROUTE102RALTS_SANCTUARY) && gSaveBlock1Ptr->location.mapNum == MAP_NUM(MAP_ROUTE102RALTS_SANCTUARY))
        return BATTLE_ENVIRONMENT_GREENGRASS;

    //if (MetatileBehavior_IsPuddle(tileBehavior) && gSaveBlock1Ptr->location.mapGroup == MAP_GROUP(MAP_ROUTE103) && gSaveBlock1Ptr->location.mapNum == MAP_NUM(MAP_ROUTE103))
        //return BATTLE_ENVIRONMENT_LONG_GRASS;

    //if (MetatileBehavior_IsSurfableWaterOrUnderwater(tileBehavior) && gSaveBlock1Ptr->location.mapGroup == MAP_GROUP(MAP_ROUTE103) && gSaveBlock1Ptr->location.mapNum == MAP_NUM(MAP_ROUTE103))
        //return BATTLE_ENVIRONMENT_BROWNWATER;
    ...
    if (GetSavedWeather() == WEATHER_SANDSTORM)
     ...
     if (GetSavedWeather() == WEATHER_SNOW)
        return BATTLE_ENVIRONMENT_SNOWY;
