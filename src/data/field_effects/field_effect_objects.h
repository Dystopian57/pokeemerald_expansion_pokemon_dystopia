...
const struct SpritePalette gSpritePalette_LongGreenGrass = {gFieldEffectObjectPaletteLongGreenGrass, FLDEFF_PAL_TAG_LONGGREENGRASS};
...
const struct SpriteTemplate gFieldEffectObjectTemplate_LongGrass = {
    .tileTag = TAG_NONE,
    .paletteTag = FLDEFF_PAL_TAG_LONGGREENGRASS,
    .oam = &gObjectEventBaseOam_16x16,
