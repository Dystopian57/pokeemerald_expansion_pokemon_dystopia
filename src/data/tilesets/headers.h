...
const struct Tileset gTileset_GeneralGreen =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_GeneralGreen,
    .palettes = gTilesetPalettes_GeneralGreen,
    .metatiles = gMetatiles_GeneralGreen,
    .metatileAttributes = gMetatileAttributes_GeneralGreen,
    .callback = NULL,
};

const struct Tileset gTileset_Landfill =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Landfill,
    .palettes = gTilesetPalettes_Landfill,
    .metatiles = gMetatiles_Landfill,
    .metatileAttributes = gMetatileAttributes_Landfill,
    .callback = NULL,
};
