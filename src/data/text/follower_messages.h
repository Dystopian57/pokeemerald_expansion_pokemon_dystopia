...
static const u8 sHappyMsg00[] = _("{STR_VAR_1} examines {PLAYER}'s injury\nwith curiosity.");
static const u8 sHappyMsg01[] = _("{STR_VAR_1} seems content.");
static const u8 sHappyMsg02[] = _("{STR_VAR_1} is obediently following along.");
static const u8 sHappyMsg03[] = _("{STR_VAR_1} is composed.");
static const u8 sHappyMsg04[] = _("{STR_VAR_1} amuses itself by\nmimicking {PLAYER}'s military pace.");
static const u8 sHappyMsg05[] = _("{STR_VAR_1} seems healthy.");
static const u8 sHappyMsg06[] = _("{STR_VAR_1} looks reasonably happy.");
static const u8 sHappyMsg07[] = _("{STR_VAR_1} points at {PLAYER},\npretending to be a trainer.");
static const u8 sHappyMsg08[] = _("{STR_VAR_1} is smelling the scents\nof the surrounding air.");
static const u8 sHappyMsg09[] = _("{STR_VAR_1} seems pumped up!");
static const u8 sHappyMsg10[] = _("{STR_VAR_1} seems in good spirits.");
static const u8 sHappyMsg11[] = _("{STR_VAR_1} has caught the scent of\nsomething.");
static const u8 sHappyMsg12[] = _("{STR_VAR_1} approaches {PLAYER} in\na tough walk.");
static const u8 sHappyMsg13[] = _("{STR_VAR_1} stretched out its body\nand is relaxing.");
...
static const u8 sHappyMsg16[] = _("{STR_VAR_1} taps {PLAYER}'s leg in a\nreassuring gesture.");
static const u8 sHappyMsg17[] = _("{STR_VAR_1} is full of energy.");
static const u8 sHappyMsg18[] = _("{STR_VAR_1} seems eager to exercise.");
static const u8 sHappyMsg19[] = _("{STR_VAR_1} looks like it wants\nto spend pent-up energy.");
static const u8 sHappyMsg20[] = _("{STR_VAR_1} nodded slowly.");
static const u8 sHappyMsg21[] = _("{STR_VAR_1} is eager to continue.");
static const u8 sHappyMsg22[] = _("{STR_VAR_1} is wandering around and\nlistening to the different sounds.");
static const u8 sHappyMsg23[] = _("{STR_VAR_1} looks at {PLAYER} with\nan innocent face.");
static const u8 sHappyMsg24[] = _("{STR_VAR_1} is somehow forcing\nitself to keep going.");
static const u8 sHappyMsg25[] = _("{STR_VAR_1} smiles sadly at {PLAYER}.");
static const u8 sHappyMsg26[] = _("{STR_VAR_1} gives {PLAYER} a look\nof appreciation.");
static const u8 sHappyMsg27[] = _("{STR_VAR_1} picks up a scent,\nbut quickly loses it.");
static const u8 sHappyMsg28[] = _("{STR_VAR_1} patiently awaits {PLAYER}\nto lead on.");
static const u8 sHappyMsg29[] = _("{STR_VAR_1} turned around expectantly.");
static const u8 sHappyMsg30[] = _("{STR_VAR_1} playfully bumps into\n{PLAYER}.");
// Conditional messages begin here, index 31
static const u8 sHappyMsg31[] = _("{STR_VAR_1} seems content about the\nweather.");
...
static const u8 sNeutralMsg00[] = _("{STR_VAR_1} is scratching\nthe ground.");
...
static const u8 sNeutralMsg09[] = _("{STR_VAR_1} danced a silly\ndance.");
...
static const u8 sSadMsg00[] = _("{STR_VAR_1} seems a bit dizzy.");
static const u8 sSadMsg01[] = _("{STR_VAR_1} is stepping on {PLAYER}'s\nfeet!");
...
static const u8 sSadMsg04[] = _("{STR_VAR_1} looks like it could\nuse some rest.");
static const u8 sSadMsg05[] = _("{STR_VAR_1} almost bumped into\n{PLAYER}.");
...
static const u8 sPensiveMsg13[] = _("{STR_VAR_1} is staring intently at\nnothing.");
...
static const u8 sPensiveMsg18[] = _("{STR_VAR_1} is looking at {PLAYER}'s\nfootprints.");
...
static const u8 sLoveMsg02[] = _("{STR_VAR_1} suddenly poked\n{PLAYER} in a friendly way.");
static const u8 sLoveMsg03[] = _("{STR_VAR_1} seems to want\nto battle.");
static const u8 sLoveMsg04[] = _("{STR_VAR_1} is rubbing against\n{PLAYER}'s legs.");
static const u8 sLoveMsg05[] = _("{STR_VAR_1} nodded optimistically.");
static const u8 sLoveMsg06[] = _("{STR_VAR_1} stands close to {PLAYER}.");
static const u8 sLoveMsg07[] = _("{STR_VAR_1} is regarding {PLAYER}\nwith trust.");
static const u8 sLoveMsg08[] = _("{STR_VAR_1} got closer to {PLAYER}.");
static const u8 sLoveMsg09[] = _("{STR_VAR_1} is keeping close to\n{PLAYER}'s feet.");
...
static const u8 sSurpriseMsg09[] = _("{STR_VAR_1} seems surprised\nat the sudden attention.");
static const u8 sSurpriseMsg10[] = _("{STR_VAR_1} was caught unawares\nby a weird smell.");
static const u8 sSurpriseMsg11[] = _("{STR_VAR_1} seems to be hiding something...");
...
static const u8 sSurpriseMsg16[] = _("{STR_VAR_1} senses something amiss...");
static const u8 sSurpriseMsg17[] = _("{STR_VAR_1} is scared and keeping\nclose to {PLAYER}");
...
static const u8 sCuriousMsg00[] = _("{STR_VAR_1} is looking around\nrestlessly for something.");
static const u8 sCuriousMsg01[] = _("{STR_VAR_1} wasn't watching where\nit was going and ran into {PLAYER}!");
static const u8 sCuriousMsg02[] = _("{STR_VAR_1} is trying to track\na smell.");
...
static const u8 sCuriousMsg05[] = _("{STR_VAR_1} is sniffing at {PLAYER}.");
...
static const u8 sMusicMsg02[] = _("{STR_VAR_1} suddenly started\ndancing for some reason.");
...
static const u8 sMusicMsg05[] = _("{STR_VAR_1} is skipping about.");
static const u8 sMusicMsg06[] = _("{STR_VAR_1} is humming a strange melody.");
static const u8 sMusicMsg07[] = _("{STR_VAR_1} is nipping at {PLAYER}'s feet");
static const u8 sMusicMsg08[] = _("{STR_VAR_1} turns around and looks\nat {PLAYER}.");
static const u8 sMusicMsg09[] = _("{STR_VAR_1} is striking\na mighty pose.");
static const u8 sMusicMsg10[] = _("{STR_VAR_1} suddenly danced.");
static const u8 sMusicMsg11[] = _("{STR_VAR_1} is feeling optimistic.");
static const u8 sMusicMsg12[] = _("{STR_VAR_1} is jumping around in a\ncarefree way!");
static const u8 sMusicMsg13[] = _("{STR_VAR_1} seems to be smelling a\nnostalgically familiar scent…");
// Conditional music messages, index 14
static const u8 sMusicMsg14[] = _("{STR_VAR_1} is very enjoying the\nrain.");
