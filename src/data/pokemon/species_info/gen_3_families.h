...
const struct SpeciesInfo gSpeciesInfoGen3[] =
{
    ...
    [SPECIES_LOMBRE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_MYSTIC_WATER, SPECIES_LUDICOLO}),
    },
...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_KIRLIA] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 30, SPECIES_GARDEVOIR}
                                ...
                                ,{EVO_ITEM, ITEM_SAPPHIRE, SPECIES_GALLADE, CONDITIONS({IF_GENDER, MON_MALE})}
                            #endif
                            ),
    },
    ...
    [SPECIES_NOSEPASS] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_PROBOPASS, CONDITIONS({IF_IN_MAPSEC, MAPSEC_NEW_MAUVILLE})},
                                {EVO_ITEM, ITEM_MAGNET, SPECIES_PROBOPASS}),
    #endif
    },
    ...
    [SPECIES_SNORUNT] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 42, SPECIES_GLALIE}
                            #if P_GEN_4_CROSS_EVOS
                                ,{EVO_ITEM, ITEM_SAPPHIRE, SPECIES_FROSLASS, CONDITIONS({IF_GENDER, MON_FEMALE})}
                            #endif
                            ),
    },
