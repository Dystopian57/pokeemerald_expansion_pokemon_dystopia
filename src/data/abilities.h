const struct AbilityInfo gAbilitiesInfo[ABILITIES_COUNT] =
{
    ...
    {
        .name = _("Sibling Seeker"),
        .description = COMPOUND_STRING("Boosts ally's Normal moves."),
        .aiRating = 2,
    },
