...
{//   Item                      1+  11+  21+  31+  41+  51+  61+  71+  81+  91+   Levels
    { ITEM_PARK_BALL,       {  35,   _,   _,   _,   _,   _,   _,   _,   _,   _, } },
    { ITEM_BALM_MUSHROOM,   {  25,  10,   _,   _,   _,   _,   _,   _,   _,   _, } },
    { ITEM_RARE_BONE,       {   8,  30,   _,   _,   _,   _,   _,   _,   _,   _, } },
    { ITEM_BLUE_SHARD,      {   8,  10,  30,   _,   _,   _,   _,   _,   _,   _, } },
    { ITEM_RED_SHARD,       {   8,  10,   9,  30,   _,   _,   _,   _,   _,   _, } },
    { ITEM_GREEN_SHARD,     {   3,  10,   9,   _,   _,   _,   _,   _,   _,   _, } },
    { ITEM_YELLOW_SHARD,    {   3,  10,   9,   9,  30,   _,   _,   _,   _,   _, } },
    { ITEM_STARDUST,        {   3,   3,   9,   8,   9,  30,   _,   _,   _,   _, } },
    { ITEM_COMET_SHARD,     {   3,   3,   3,   8,   8,   9,  30,   _,   _,   _, } },
    { ITEM_BOTTLE_CAP,      {   3,   3,   3,   4,   8,   9,   8,  30,   _,   _, } },
    { ITEM_GOLD_BOTTLE_CAP, {   1,   1,   3,   4,   4,   _,   _,   _,   _,   _, } },
    { ITEM_CHOICE_SCARF,            {   _,   3,   3,   4,   4,   9,   8,   8,  30,   _, } },
    { ITEM_CHOICE_SPECS,        {   _,   3,   3,   4,   4,   4,   4,   5,   9,  10, } },
    { ITEM_CHOICE_BAND,          {   _,   3,   3,   4,   4,   4,   4,   5,   9,  10, } },
    { ITEM_RUBY,      {   _,   1,   1,   1,   1,   4,   4,   5,   4,   5, } },
    { ITEM_SAPPHIRE,          {   _,   _,   3,   4,   4,   4,   4,   5,   4,   5, } },
    { ITEM_NUGGET,      {   _,   _,   3,   4,   4,   4,   8,   8,   9,  30, } },
