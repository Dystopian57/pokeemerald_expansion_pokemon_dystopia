...
void CB2_InitTitleScreen(void)
{
    ...
    case 4:
        ...
        SetGpuReg(REG_OFFSET_DISPCNT, DISPCNT_MODE_1
                                    ...
                                    | DISPCNT_WIN0_ON
                                    | DISPCNT_OBJWIN_ON);
        m4aSongNumStart(MUS_WEATHER_GROUDON);
        gMain.state = 5;
        break;
    case 5:
...
*/
    {
        .color1 = RGB2GBA(189, 156, 255),
        .color2 = RGB2GBA(222, 213, 255),
        .colorIndex = 15

    },

    {
        .color1 = RGB2GBA(99, 33, 140),
        .color2 = RGB2GBA(186, 0, 198),
        .colorIndex = 2
    },

        {
        .color1 = RGB2GBA(82, 0, 189),
        .color2 = RGB2GBA(111, 132, 255),
        .colorIndex = 6
    },
