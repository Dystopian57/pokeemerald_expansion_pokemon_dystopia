...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_SHADYDEALERM] = { _("SHADY DEALER"), 15, BALL_PARK },    
    [TRAINER_CLASS_CONSCRIPTM] = { _("CONSCRIPT♂"), 50, BALL_SAFARI },
    [TRAINER_CLASS_CONSCRIPTF] = { _("CONSCRIPT♀"), 10, BALL_SAFARI },   
    [TRAINER_CLASS_FOREIGNSPYM] = { _("FOREIGN SPY"), 10, BALL_POKE },
    [TRAINER_CLASS_GANGBIKERF] = { _("GANG BIKER♀"), 1, BALL_DUSK },    
    [TRAINER_CLASS_GANGBIKERM] = { _("GANG BIKER♂"), 20, BALL_FAST },
    [TRAINER_CLASS_HAZARDDIVERM] = { _("HAZARD DIVER"), 20, BALL_DIVE }, 
    [TRAINER_CLASS_MERCENARYF] = { _("MERCENARY♀"), 15, BALL_SAFARI },    
    [TRAINER_CLASS_PATIENTF] = { _("PATIENT♀"), 15, BALL_PREMIER }, 
