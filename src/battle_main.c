...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_ORPHAN] = { _("ORPHAN♂"), 1, BALL_PARK },
    //♂ ♀
    [TRAINER_CLASS_CAMELIA] = { _("CAMELIA"), 20, BALL_CHERISH }, 
    [TRAINER_CLASS_CLERKF] = { _("CLERK♀"), 15, BALL_GREAT },    
    [TRAINER_CLASS_COSPLAYERF] = { _("COSPLAYER♀"), 20, BALL_LOVE },
    [TRAINER_CLASS_COSPLAYERM] = { _("COSPLAYER♂"), 20, BALL_LURE },   
    [TRAINER_CLASS_DEVONADMINF] = { _("DEVON ADMIN♀"), 40, BALL_GREAT },
    [TRAINER_CLASS_DEVONADMINM] = { _("DEVON ADMIN♂"), 45, BALL_GREAT },    
    [TRAINER_CLASS_DEVONGRUNTF] = { _("DEVON GRUNT♀"), 20, BALL_GREAT },
    [TRAINER_CLASS_DEVONGRUNTM] = { _("DEVON GRUNT♂"), 25, BALL_GREAT },   
    [TRAINER_CLASS_HERMITM] = { _("HERMIT"), 1, BALL_FRIEND },
    [TRAINER_CLASS_MEDICM] = { _("MEDIC"), 25, BALL_HEAL },    
    [TRAINER_CLASS_MERCENARYM] = { _("MERCENARY♂"), 10, BALL_SAFARI },
    [TRAINER_CLASS_MUSASHI] = { _("MUSASHI"), 10, BALL_TIMER },   
    [TRAINER_CLASS_NETRUNNERF] = { _("NETRUNNER♀"), 30, BALL_STRANGE },
    [TRAINER_CLASS_NETRUNNERM] = { _("NETRUNNER♂"), 35, BALL_STRANGE },    
    [TRAINER_CLASS_OLDNORMAN] = { _("NORMAN"), 30, BALL_ULTRA },
    [TRAINER_CLASS_ORPHANGIRLF] = { _("ORPHAN♀"), 1, BALL_PARK },   
    [TRAINER_CLASS_PATIENTM] = { _("PATIENT♂"), 5, BALL_PREMIER },
    [TRAINER_CLASS_PUNKF] = { _("PUNK♀"), 10, BALL_DREAM },    
    [TRAINER_CLASS_PUNKM] = { _("PUNK♂"), 10, BALL_MOON },
    [TRAINER_CLASS_REBELADMINF] = { _("REBEL ADMIN♀"), 25, BALL_DUSK },   
    [TRAINER_CLASS_REBELADMINM] = { _("REBEL ADMIN♂"), 20, BALL_HEAVY },
    [TRAINER_CLASS_REBELGRUNTF] = { _("REBEL GRUNT♀"), 10, BALL_PARK },    
    [TRAINER_CLASS_REBELGRUNTM] = { _("REBEL GRUNT♂"), 10, BALL_PARK },
    [TRAINER_CLASS_REPORTERS] = { _("REPORTERS"), 25, BALL_POKE },   
    [TRAINER_CLASS_ROXANNEDEVON] = { _("DEVON ADMIN"), 35, BALL_GREAT },
    [TRAINER_CLASS_SCAVENGERF] = { _("SCAVENGER♀"), 10, BALL_PARK },    
    [TRAINER_CLASS_SCAVENGERM] = { _("SCAVENGER♂"), 10, BALL_PARK },
    [TRAINER_CLASS_SCIENTISTF] = { _("RESEARCHER♀"), 35, BALL_BEAST },   
    [TRAINER_CLASS_SCIENTISTM] = { _("RESEARCHER♂"), 40, BALL_BEAST },
    [TRAINER_CLASS_SHARPY] = { _("TRAINER"), 15, BALL_DIVE },    
    [TRAINER_CLASS_SIDNEYREBEL] = { _("REBEL ADMIN"), 50, BALL_LUXURY },
    [TRAINER_CLASS_TECHNICIANF] = { _("TECHNICIAN♀"), 10, BALL_FAST },   
    [TRAINER_CLASS_TECHNICIANM] = { _("TECHNICIAN♂"), 10, BALL_FAST },
    [TRAINER_CLASS_THEORISTM] = { _("THEORIST"), 1, BALL_PARK },    
    [TRAINER_CLASS_TOMOKO] = { _("DISCIPLE"), 20, BALL_SPORT },
    [TRAINER_CLASS_TOURISTF] = { _("WAR TOURIST♀"), 20, BALL_NEST}, 
    [TRAINER_CLASS_TOURISTM] = { _("WAR TOURIST♂"), 15, BALL_NEST },    
    [TRAINER_CLASS_VETERANM] = { _("VETERAN"), 15, BALL_SAFARI },  

    [TRAINER_CLASS_SHADYDEALERM] = { _("SHADY DEALER"), 30, BALL_PARK },    
    [TRAINER_CLASS_CONSCRIPTM] = { _("CONSCRIPT♂"), 10, BALL_SAFARI },
    [TRAINER_CLASS_CONSCRIPTF] = { _("CONSCRIPT♀"), 10, BALL_SAFARI },   
    [TRAINER_CLASS_FOREIGNSPYM] = { _("FOREIGN SPY"), 20, BALL_POKE },
    [TRAINER_CLASS_GANGBIKERF] = { _("GANG BIKER♀"), 15, BALL_DUSK },    
    [TRAINER_CLASS_GANGBIKERM] = { _("GANG BIKER♂"), 15, BALL_FAST },
    [TRAINER_CLASS_HAZARDDIVERM] = { _("HAZARD DIVER"), 10, BALL_DIVE }, 
    [TRAINER_CLASS_MERCENARYF] = { _("MERCENARY♀"), 20, BALL_SAFARI },    
    [TRAINER_CLASS_PATIENTF] = { _("PATIENT♀"), 10, BALL_PREMIER },
    [TRAINER_CLASS_BALSAM] = { _("{PKMN} PROF."), 30, BALL_PREMIER }, 

    [TRAINER_CLASS_WAGESLAVEM] = { _("WAGE SLAVE♂"), 15, BALL_POKE },
    [TRAINER_CLASS_ESCAPEDPRISONERM] = { _("EX CONVICT♂"), 10, BALL_POKE }, 
    [TRAINER_CLASS_LANETTE] = { _("REBEL HACKER"), 20, BALL_BEAST },    
    [TRAINER_CLASS_BRIGETTE] = { _("DEVON ADMIN"), 10, BALL_BEAST },
    [TRAINER_CLASS_OLDWALLY] = { _("JADED DOCTOR"), 30, BALL_PREMIER },

    [TRAINER_CLASS_SURGE] = { _("CAPTAIN"), 20, BALL_BEAST },    
    [TRAINER_CLASS_FALKNER] = { _("RONIN"), 10, BALL_BEAST },
    [TRAINER_CLASS_ARTIE] = { _("DEMAGOGUE"), 30, BALL_PREMIER },

    [TRAINER_CLASS_MOXIE] = { _("PUNK LEADER"), 10, BALL_PARK },
    [TRAINER_CLASS_DEVONDRONE] = { _("DEVON DRONE"), 30, BALL_BEAST }, 
