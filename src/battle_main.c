...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_DEVONADMINF] = { _("DEVON ADMIN♀"), 40, BALL_POKE },
    [TRAINER_CLASS_DEVONADMINM] = { _("DEVON ADMIN♂"), 45, BALL_POKE },    
    [TRAINER_CLASS_DEVONGRUNTF] = { _("DEVON GRUNT♀"), 20, BALL_POKE },
    [TRAINER_CLASS_DEVONGRUNTM] = { _("DEVON GRUNT♂"), 25, BALL_POKE },   
